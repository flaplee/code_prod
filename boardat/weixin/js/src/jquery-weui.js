...
+ function($) {
  ...
  $.prompt = function(text, title, onOK, onCancel, input, maxlength, modify) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">'+(config.text || '')+'</p><input type="text" class="weui-input weui-prompt-input" id="weui-prompt-input" maxlength="' + (config.maxlength || '') + '" value="' + (config.input || '') + '" />',
      title: config.title,
      autoClose: false,
      buttons: [
      {
