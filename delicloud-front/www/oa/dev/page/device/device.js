                            ...
                            if (device) {
                                ...
                                var $deviceTpl = $('<tr class="dev-item" data-dev_id="' + binds[j].device_id + '">\
									...
									<td class="item-delact">\
										<a href="javascript:;" class="button button-solid-purple btn-dev-rename-item">修改设备名称</a>\
										<a href="javascript:;" class="button button-solid-orange  btn-dev-delete-item">删除设备</a>\
