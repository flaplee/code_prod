        ...
        init: function() {
            setTimeout(function(){
                ...
                deli.common.navigation.goBack({
                    ...
                    deli.common.navigation.goBack({is_go_back:data.is_go_back},function(data){},function(resp){});
                    if(data.is_go_back == 0){
                        location.href = 'http://t.h5.delicloud.com/web/delicloud-local/index.html';
                    }else{
                        deli.common.navigation.setTitle({
                            "title": "测试返回页面1"
                        }, function(data) {}, function(resp) {});
