...
function configure(PDFJS) {
  ...
  PDFJS.cMapUrl = 'https://unpkg.com/pdfjs-dist@1.9.426/cmaps/';//../web/cmaps/
  ...
  _createClass(Toolbar, [{
    ...
    value: function _updateUIState() {
      ...
      if (resetNumPages) {
        if (this.hasPageLabels) {
          ...
          this.l10n.get('of_pages', { pagesCount: pagesCount }, 'of {{pagesCount}}').then(function (msg) {
            ...
            items.numPagesNew.textContent = msg;
          });
        }
      ...
      if (this.hasPageLabels) {
        ...
        items.pageNumberNew.value = pageNumber;
      }
...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      numPagesNew: document.getElementById('numPagesNew'),
      pageNumber: document.getElementById('pageNumber'),
      pageNumberNew: document.getElementById('pageNumberNew'),
