    ...
    var Page = {
        init: function() {
            ...
            self.dataHandler.getShare.call(self, [util.getQuery("id"), function(data) {
                self.data.meetingShare = data; //data.meeting_share_list
                ...
                // 异步加载图片
                var imgs = document.querySelectorAll('.item-cont img.item-img');
        ...
        viewHandler: {
            list: function(n) {
                var self = this;
                var detail = (n.screenshots) ? (self.viewHandler.detail.call(self, n.screenshots)) : '';
            ...
            detail: function(n) {
                ...
                var result = '  <p class="item-date">' + util.formatDate(n.update_time * 1, "full") + '</p>\
                <div class="item-cont">\
